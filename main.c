...
// WordNode* shortestRecursive(char **dict, int dictSize, , bool *used, int
// wordSize, LadderNode* thisLadder, char* finalWord) {
...
//     /*
//     potential problem:
//         how will other search tree know if word has already been attempted in
//         previous tree?
//         - each recursive call is a new ladder, so used array should reflect
//         accurate cache
//     */
...
//       // if not, repeatedly allow user to enter another word until one is
//       valid while (!checkForValidWord(words, numWords, wordSize, userLadder,
//       aWord)) {
